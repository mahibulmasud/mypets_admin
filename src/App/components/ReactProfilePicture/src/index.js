...
class ProfilePicture extends Component {
    ...
    render() {
        ...
        // ];
        return (
            <div className={"_1Fq_tZ_l7SwH_r_a_SNOtA _1zaTZoyOruLA27LomLt6fx"}>
                <div className={stylesheet["profile-picture__photo"]}>
                    <div
                        className={"_1Ou1tAFc1VCD4TNa0XwE7z"}
                        onMouseDown={
                    ...
                    >
                        ...
                        >
                            {this.props.useHelper ? (
                                <canvas
                                    className={"_33ob_2Sxjrzz9VgWuEn9xb"}
                                    ref={this.helperRef}
                                />
                            ) : null}
                            <Frame
                            ...
                            >
                                <canvas
                                    ...
                                    className={"_1DghVSjROos1S_s0jPt9TQ"}
                                    ref={this.canvasRef}
                                />
                                {this.renderMessages()}
                            </Frame>
                    ...
                    <div className={"GNSzzq7thIGJvQKQMnUF4"}>
                        {this.state.status === Status.LOADED ? (
                            <Fragment>
                                <div className={"_34iiqkc-jTKb3N7DvLLkwC"}>
                                    <ZoomScale
                                ...
                                <div className={"_10Kns8R3VdHSGFrESIz-4B"}>
                                    <button
                                        className={"_1YelFC_KTV9aLijs9ogXcQ"}
                                        onClick={this.handleRemove.bind(this)}
                                    >
                                        <Icon className={"Icon Icon--trash "} name="trash" size={20}/>
                                    </button>
                                </div>
                            </Fragment>
                        ) : null}
                ...
                <input
                    className={"_2Y6QsytFkIen8EZ8qRminO"}
                    type="file"
